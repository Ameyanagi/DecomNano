...
DecomNano could always use more documentation, whether as part of the
official DecomNano docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `decomnano` repo on GitHub.
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Make sure that the tests pass for all supported Python versions.
